import { addProductByIdToWishlist, addProductByIdToCart, getCategories, getClearForm, getModal, getProducts, getProductsByQuery, handleCategoryClick } from './js/handlers';
